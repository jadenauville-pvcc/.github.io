...
def open_outfile():
    ...
    f.write('''
            ...
            <style>
                body {background-color: #17252A; color: #FEFFFF;}
                td {text-align: right; font-family: arial;}
            </style>
            </head>
            <body>
            ''')
...
def display_results():
    ...
    endtr = '</td></tr>\n'
    f.write('''
            <table border=1 style ="background-color:#3AAFA9;font-family: arial; margin: auto;">
            <tr><td colspan = 2>
