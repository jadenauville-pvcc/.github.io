# Name: Jaden Auville
# Program Purpose: This program uses lists to find the personal property tax for vehicles in Charlottesville and produces a report which displays all data and the total tax due for six months
#
...
def display_results():
    ...
    print (line)
    print ("*************************************************** TOAL TAX DUE: " + tab + format(total,moneyf))
